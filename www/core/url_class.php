...
class URL {
	...
	//==========================================
	// возвращает массив с названием контроллера и обработчика
	// например http://herbal24.ru/registr/actionuser
	// registr - контроллер, actionuser - обработчик(экшион)
	// по умолчанию контроллер - "Main", а экшион - "index"
